...
const { run: runPostEditStandards } = require('./post-edit-standards');
...
const ASYNC_HOOKS = [
  ...
  { id: 'post:edit:standards', matcher: 'Edit|Write|MultiEdit', profiles: 'standard,strict', script: 'scripts/hooks/post-edit-standards.js', run: runPostEditStandards },
