...
// Removed: 'business launch copy stays aligned with the rc.1 public surface'.
// It asserted on docs/business/social-launch-copy.md, part of the upstream author's
// business assets deliberately removed in 2cc00a13. See MERGE-PROBLEM-ANALYSIS.md C4.

test('announcement drafts avoid live-release claims before publication', () => {
  // docs/business/social-launch-copy.md dropped from this list — removed in 2cc00a13.
  const announcementFiles = ['docs/releases/2.0.0-rc.1/linkedin-post.md', 'docs/releases/2.0.0-rc.1/partner-sponsor-talks-pack.md'];
...
test('active release identity surfaces use canonical ECC repo URLs', () => {
  const activeFiles = [
    ...
    // docs/business/metrics-and-sponsorship.md removed in 2cc00a13 (upstream business assets).
