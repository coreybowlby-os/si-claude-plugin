...
function assertHonestComputeCopy(content) {
  ...
  assert.match(content, /sicp ito find/i);
...
function main() {
  ...
  const tests = [
    ...
    // Removed: 'sponsor docs match the current public tiers'. Asserted on SPONSORS.md,
    // which lists the upstream author's sponsors and was removed at fork time (14aa9399).
    // See MERGE-PROBLEM-ANALYSIS.md C4.
    ...
    // Removed: 'sponsor roster keeps Itô and Moonshot distinct from node tooling'.
    // Asserted on SPONSORS.md, removed at fork time (14aa9399). See MERGE-PROBLEM-ANALYSIS.md C4.
    ...
    ['npm package publishes the Ito mark and welcome route', () => {
      ...
      assert.match(packageJson.scripts.welcome, /sicp ito find/i);
