...
const SURFACES = [
  ...
  // Removed: docs/business/team-agent-orchestration-content-pack.md — upstream marketing
  // content deliberately dropped in 2cc00a13. See MERGE-PROBLEM-ANALYSIS.md C4.
];
