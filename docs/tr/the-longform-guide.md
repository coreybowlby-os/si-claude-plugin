...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/coreybowlby-os/SI-Claude-Plugin`
...
*Oturum depolama örneği -> <https://github.com/coreybowlby-os/SI-Claude-Plugin/tree/main/examples/sessions>*
...
Bu hook'ları oluşturdum ve repo'da `github.com/coreybowlby-os/SI-Claude-Plugin/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/coreybowlby-os/SI-Claude-Plugin/tree/main/skills/continuous-learning`
...
*Her iki kılavuzda ele alınan her şey GitHub'da [SI-Claude-Plugin](https://github.com/coreybowlby-os/SI-Claude-Plugin) adresinde mevcuttur*
