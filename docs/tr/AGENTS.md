...
Bu, yazılım geliştirme için 68 özel agent, 300 skill, 94 command ve otomatik hook iş akışları sağlayan **üretime hazır bir AI kodlama eklentisidir**.
...
skills/          — 300 iş akışı skillleri ve alan bilgisi
