...
SI Claude Plugin (ECC) 插件的常见问题与解决方案。
...
1. **检查 GitHub Issues**：[github.com/coreybowlby-os/SI-Claude-Plugin/issues](https://github.com/coreybowlby-os/SI-Claude-Plugin/issues)
2. **启用调试日志记录**：
   ```bash
   export CLAUDE_DEBUG=1
